...
func (app *Helper) ReadJSON(w http.ResponseWriter, r *http.Request, data any) error {
...
func (app *Helper) WriteJSON(w http.ResponseWriter, status int, data any, headers ...http.Header) error {
...
func (app *Helper) ErrorJSON(w http.ResponseWriter, err error, status ...int) error {
